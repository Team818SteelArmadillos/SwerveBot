...
public class SwerveModuleConstants {
    ...
    public SlotConfiguration SteerMotorGains = new SlotConfiguration();
    /** The drive motor gains */
    public SlotConfiguration DriveMotorGains = new SlotConfiguration();
    ...
    public SwerveModuleConstants withSteerMotorGains(SlotConfiguration gains) {
        this.SteerMotorGains = gains;
        return this;
    }

    public SwerveModuleConstants withDriveMotorGains(SlotConfiguration gains) {
