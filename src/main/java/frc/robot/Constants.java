...
public final class Constants {
    ...
    /* Swerve Gear Ratios */
    public static final double DRIVE_GEAR_RATIO = (1.0); //6.86:1 from SDS
    public static final double AZIMUTH_GEAR_RATIO = (1.0); //12.8:1 from SDS
    ...
    // public static final double FIVE_BALL_FEEDER_TICKS = 150000;
